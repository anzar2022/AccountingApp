...
namespace TransactionApi.Dtos
{
    ...
    public record GetAccountTransactionWithIntDto(Guid Id, double InterestRate, double PrincipalAmount, double InterestAmount, double PaidInterestAmount,  string EmiMonth, Guid? InterestEMIId, string AccountName);
    public record GetAccountTransactionsWithIntDto(Guid Id, double InterestRate, double PrincipalAmount, double InterestAmount, double PaidInterestAmount, string EmiMonth, Guid? InterestEMIId, string AccountName);
